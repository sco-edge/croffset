...
def plot(r_points, s_points, c_points, a_points, r_points2, s_points2, c_points2, a_points2, name):
    ...
    xlabel = "# of spurious retx.\nof a single BBR flow"
    # ax1.set_xlabel('# of spurious retransmissions')
    ax1.set_xlabel(xlabel)
    ax1.set_ylabel('eCDF')
    # ax1.legend()
    ax1.set_xticks([0, 100, 200, 300, 400], ["0", "100", "200", "300", "400"])
    ...
    ax2.set_xticks([0, 50, 100, 150, 200], ["0", "50", "100", "150", "200"])
...
if __name__ == "__main__":
    ...
    parse_dataset(cubic, "../../dataset-perf/cubic-20240421-c1-2")
    parse_dataset(cubic, "../../dataset-perf/cubic-20240421-c1-3")
    parse_dataset(cubic, "../../dataset-perf/cubic-20240421-c1-4")
    parse_dataset(cubic, "../../dataset-perf/cubic-20240421-c1-5")
    ...
    plot(r_points, s_points, c_points, a_points, r_points2, s_points2, c_points2, a_points2, "fig5-compensation-single")